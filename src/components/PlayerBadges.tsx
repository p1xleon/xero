...
const PlayerBadges = ({ ...props }: PlayerBadgeProps) => {
  return (
    <View style={styles.container}>
      ...
      <Badge value={`TH${props.townhall}`} imageUrl={TownHallMap[props.townhall]} />
      ...
      {props.league && (
        <Badge
          value={props.league ? props.league : "Unranked"}
          imageUrl={
            "https://static.wikia.nocookie.net/clashofclans/images/c/c0/Unranked_League.png/revision/latest/scale-to-width-down/92?cb=20171003011534"
          }
        />
      ...
      {/* <Badge
        value={props.builderBaseLeague.name}
        imageUrl={
          props.league
            ? props.league.iconUrls.medium
            : "https://static.wikia.nocookie.net/clashofclans/images/c/c0/Unranked_League.png/revision/latest/scale-to-width-down/92?cb=20171003011534"
        }
      /> */}
